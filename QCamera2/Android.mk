...
LOCAL_C_INCLUDES := \
        ...
        $(LOCAL_PATH)/util \
        $(LOCAL_PATH)/HAL3 \
        hardware/qcom/caf-4.9/media/libstagefrighthw \
        hardware/qcom/caf-4.9/media/mm-core/inc \
...
LOCAL_C_INCLUDES += \
        vendor/sony/camera/QCamera2/HAL
...
LOCAL_C_INCLUDES += \
        hardware/qcom/caf-4.9/display/libqservice
